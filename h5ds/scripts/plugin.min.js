/** H5DS v1.0 by 馒头 qq：676015863 */!function(a){a.fn.center=function(b){var c=a.extend({position:"absolute",top:"50%",left:"50%",zIndex:9999,relative:!0},b||{});return this.each(function(){var b=a(this);"50%"==c.top&&(c.marginTop=-b.outerHeight()/2),"50%"==c.left&&(c.marginLeft=-b.outerWidth()/2),c.relative&&!b.parent().is("body")&&"static"==b.parent().css("position")&&b.parent().css("position","relative"),delete c.relative,"fixed"==c.position&&"6.0"==a.browser.version&&(c.marginTop+=a(window).scrollTop(),c.position="absolute",a(window).scroll(function(){b.stop().animate({marginTop:a(window).scrollTop()-b.outerHeight()/2})})),b.css(c)})}}(jQuery),function(a){a.fn.center2=function(b){var c=a.extend({position:"absolute",top:"50%",left:"50%",zIndex:9999,relative:!0},b||{});return this.each(function(){var b=a(this);"50%"==c.top&&(c.marginTop=-b.outerHeight()/2),"50%"==c.left&&(c.left=(b.parent().width()-b.width())/2),b.css(c)})}}(jQuery),function(a){a.fn.selectMt=function(b){var c={callback:null},b=a.extend(c,b);this.each(function(){var c=a(this),d=c.find("span"),e=c.find("ul"),f=e.find("li");d.click(function(){e.is(":hidden")?e.css({display:"block"}):e.css({display:"none"})}),f.on("click",function(){e.css({display:"none"});var f=a(this).html();c.attr("dataValue",f),d.html(f+"<i></i>"),null!=b.callback&&b.callback(f)})})}}(jQuery),function(a){a.fn.showWindow=function(b){var c={id:null,speed:300,center:!0,callback:null},b=a.extend(c,b);this.each(function(){var c=a(this);if(null==b.id)return void alert("showWindow插件必须填入一个name参数，且必须是ID!");var d=a("#fixedBox"),e="#"+b.id,f=b.speed,g=a(e),h=function(a){a.parent().fadeOut(f,function(){a.off("click"),d.css({display:"none"})})};c.click(function(){d.css({display:"block"}),1==b.center&&g.center(),g.fadeIn(f).find(".close").off("click").on("click",function(){h(a(this)),null!=b.callback&&b.callback("no")}),g.find(".yes").off("click").on("click",function(){h(a(this)),null!=b.callback&&b.callback("yes")})})})}}(jQuery),function(a){a.fn.dragListMt=function(b){var c={callback:null,liheight:50,xfloat:0,yfloat:10},b=a.extend(c,b);this.each(function(){var c=a(this),d=c.find("li").length,e={x_down:null,y_down:null,x_move:null,y_move:null,x_end:null,y_end:null,index:null,start_className:null},f=function(a,d,e,f){var g=c.find("li"),h=parseInt((e-f)/b.liheight);return 0>=a+h?(g.removeClass("drag-mousedown"),void g.first().addClass("drag-mousedown")):a+h>=g.length?(g.removeClass("drag-mousedown"),void g.last().addClass("drag-mousedown")):(g.removeClass("drag-mousedown"),void g.eq(a+h).addClass("drag-mousedown"))},g=function(a,d,f){var g=c.find("li"),h=null;g.removeClass("drag-mousedown"),h=g.eq(a).html(),a!=d&&g.eq(a).remove(),a>d?g.eq(d).before("<li>"+h+"</li>"):d>a&&g.eq(d).after("<li>"+h+"</li>");var i=c.find(".drag-span"),j=i.position().top;i.css({top:j+(a-d)*b.liheight}),i.animate({top:0,left:0},function(){i.remove(),g=c.find("li"),g.eq(d).attr("class",e.start_className)}),null!=b.callback&&b.callback(a,d)},h=function(a,b){b.addClass("zIndexMax"),b.addClass("drag-mousedown"),b.append(a.clone().addClass("drag-span")),$dragSpan=b.find(".drag-span").css({visibility:"visible",opacity:.7,"z-index":10})};c.on("mousedown.drag",".dragdiv",function(i){if(3==i.which)return!1;var j=a(this),k=j.parent(),l=1;e.y_down=i.pageY,e.x_down=i.pageX,e.index=k.index(),e.start_className=k.attr("class"),k.removeClass(),a(document).on("mousemove.drag",function(a){e.y_move=a.pageY,e.x_move=a.pageX-e.x_down,e.x_move>=b.xfloat&&(e.x_move=b.xfloat),e.x_move<=-b.xfloat&&(e.x_move=-b.xfloat),(e.y_move-e.y_down>=b.yfloat||e.y_move-e.y_down<=-b.yfloat)&&(1==l&&(h(j,k),l=0),$dragSpan.css({top:e.y_move-e.y_down,left:e.x_move}),f(e.index,d,e.y_move,e.y_down))}).on("mouseup.drag",function(b){if(a(this).off("mousemove.drag mouseup.drag"),0==l){var d=c.find(".drag-mousedown"),f=d.index();c.find("li").removeClass("zIndexMax"),g(e.index,f,d),l=1}})})})}}(jQuery),function($){$.fn.sliderMt=function(setting){var defaults={slider_callback:null,input_callback:null,iniData:0},setting=$.extend(defaults,setting);this.each(function(){var $this=$(this),_obj={$bar:$this.find("em.s-slider-bar"),$btn:$this.find("i.s-ico-slider"),data:null,width:null,value:null,padding:5,$input:$this.next("input.slider-input")};_obj.width=$this.width(),_obj.data=eval("({"+$this.attr("data")+"})"),_obj.data.minData=parseFloat(_obj.data.minData),_obj.data.maxData=parseFloat(_obj.data.maxData),_obj.data.iniData=setting.iniData,_obj.value=_obj.data.maxData-_obj.data.minData;var iniSliderEmPosition=function(){var a=(_obj.data.iniData-_obj.data.minData)/_obj.value*_obj.width;_obj.$bar.width(a),_obj.$btn.css("left",a-_obj.padding)};iniSliderEmPosition(),_obj.$input.off("change").on("change",function(){var a=$(this).val();if(!(a<_obj.data.minData||a>_obj.data.maxData)){var b=(a-_obj.data.minData)/(_obj.data.maxData-_obj.data.minData)*_obj.width;_obj.$btn.css({left:b}),_obj.$bar.width(b+_obj.padding),null!=setting.input_callback&&setting.input_callback(a)}}),_obj.$btn.off("mousedown").on("mousedown",function(a){var b={x_start:null,x_move:null,x_end:null,left_start:null,moveWidth:null},c=null,d=null;b.x_start=a.pageX,b.left_start=_obj.$btn.position().left,$(document).on("mousemove.sevenSlider",function(a){b.x_move=a.pageX-b.x_start,b.moveWidth=b.x_move+b.left_start,b.moveWidth>=-_obj.padding&&b.moveWidth<=_obj.width-_obj.padding&&(_obj.$btn.css({left:b.moveWidth}),_obj.$bar.width(b.moveWidth+_obj.padding)),c=((_obj.$btn.position().left+_obj.padding)/_obj.width).toFixed(2),d=parseFloat(((_obj.data.maxData-_obj.data.minData)*c).toFixed(0))+_obj.data.minData,_obj.$input.val(d),null!=setting.slider_callback&&setting.slider_callback(d)}).on("mouseup.sevenSlider",function(a){$(document).off("mousemove.sevenSlider mouseup.sevenSlider")})})})}}(jQuery),function(a){a.fn.rotationDegrees=function(){var a=this.css("-webkit-transform")||this.css("-moz-transform")||this.css("-ms-transform")||this.css("-o-transform")||this.css("transform");if("string"==typeof a&&"none"!==a)var b=a.split("(")[1].split(")")[0].split(","),c=b[0],d=b[1],e=c,e=Math.round(Math.atan2(d,c)*(180/Math.PI));else var e=0;return e}}(jQuery),String.prototype.colorHex=function(){function a(a){return("0"+parseInt(a).toString(16)).slice(-2)}var b=this;if(-1!=b.indexOf("rgb")||-1!=b.indexOf("RGB")){var c=b.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/);return c=null!=c?"#"+a(c[1])+a(c[2])+a(c[3]):"none"}return b},String.prototype.colorRgb=function(){var a=this.toLowerCase();if(a&&reg.test(a)){if(4===a.length){for(var b="#",c=1;4>c;c+=1)b+=a.slice(c,c+1).concat(a.slice(c,c+1));a=b}for(var d=[],c=1;7>c;c+=2)d.push(parseInt("0x"+a.slice(c,c+2)));return"RGB("+d.join(",")+")"}return a},function(a){a.fn.donwSelectMt=function(b){var c={delay:0,callback:function(a){}},b=a.extend(c,b);this.each(function(){var c=a(this),d={spanId:null,$this:null,$ul:null,height:null,delay:b.delay},e=function(){},f=function(a){a.$this.css("z-index",9999),a.$ul.css({display:"block"})},g=function(b){a(document).off("click."+b.spanId),b.$ul.css({display:"none"}),b.$this.removeAttr("style")},h=function(){var e=c.find("span");""==e.html()&&e.html(e.attr("placeholder")),e.off("click.bindEvent").on("click.bindEvent",function(){d.$this=e.parent(),d.spanId=e.attr("id"),d.$ul=d.$this.find("ul"),d.height=d.$this.data("height"),d.$ul.is(":hidden")?(f(d),d.$ul.off("click.bindEventUl").on("click.bindEventUl","li",function(){e.html(a(this).html()),e.attr("data",a(this).attr("data")),b.callback(a(this).attr("data")),g(d)})):g(d),a(document).off("click."+d.spanId).on("click."+d.spanId,function(a){var a=a||window.event,b=a.target||a.srcElement;b.id!=d.spanId&&g(d)})})};e(),h()})}}(jQuery),function(a){a.fn.dragMt=function(b){var c={dragParent:!1},b=a.extend(c,b);this.each(function(){var c=a(this);c.on("mousedown",function(d){var e={x_start:null,y_start:null,x_move:null,y_move:null,x_end:null,y_end:null,left:null,top:null};if(1==b.dragParent)var f=c.parent();else var f=c;e.x_start=d.pageX,e.y_start=d.pageY,e.left=f.position().left+f.parent().get(0).scrollLeft,e.top=f.position().top+f.parent().get(0).scrollTop,a(document).on("mousemove.dragMt",function(a){e.x_move=a.pageX-e.x_start+e.left,e.y_move=a.pageY-e.y_start+e.top,e.y_move<0&&(e.y_move=0),e.x_move<0&&(e.x_move=0),f.css({left:e.x_move,top:e.y_move})}).on("mouseup.dragMt",function(b){a(document).off("mousemove.dragMt mouseup.dragMt")})})})}}(jQuery);var ZYFILE={fileInput:null,uploadInput:null,dragDrop:null,url:"",uploadFile:[],lastUploadFile:[],perUploadFile:[],fileNum:0,filterFile:function(a){return a},onSelect:function(a,b){},onDelete:function(a,b){},onProgress:function(a,b,c){},onSuccess:function(a,b){},onFailure:function(a,b){},onComplete:function(a){},funDragHover:function(a){return a.stopPropagation(),a.preventDefault(),this["dragover"===a.type?"onDragOver":"onDragLeave"].call(a.target),this},funGetFiles:function(a){var b=this;this.funDragHover(a);var c=a.target.files||a.dataTransfer.files;b.lastUploadFile=this.uploadFile,this.uploadFile=this.uploadFile.concat(this.filterFile(c));var d=[],e=[],f=[];return $.each(b.lastUploadFile,function(a,b){e.push(b.name)}),$.each(b.uploadFile,function(a,b){f.push(b.name)}),$.each(f,function(a,c){$.inArray(c,e)<0&&d.push(b.uploadFile[a])}),this.uploadFile=d,this.funDealtFiles(),!0},funDealtFiles:function(){var a=this;$.each(this.uploadFile,function(b,c){c.index=a.fileNum,a.fileNum++});var b=this.uploadFile;return this.perUploadFile=this.perUploadFile.concat(this.uploadFile),this.uploadFile=this.lastUploadFile.concat(this.uploadFile),this.onSelect(b,this.uploadFile),this},funDeleteFile:function(a,b){var c=this,d=[],e=this.perUploadFile[a];return $.each(this.uploadFile,function(a,b){e!=b&&d.push(b)}),this.uploadFile=d,b&&c.onDelete(e,this.uploadFile),!0},funUploadFiles:function(){var a=this;$.each(this.uploadFile,function(b,c){a.funUploadFile(c)})},funUploadFile:function(a){var b=this,c=new FormData;c.append("fileList",a);var d=new XMLHttpRequest;d.upload.addEventListener("progress",function(c){b.onProgress(a,c.loaded,c.total)},!1),d.addEventListener("load",function(c){b.funDeleteFile(a.index,!1),b.onSuccess(a,d.responseText),0==b.uploadFile.length&&b.onComplete("全部完成")},!1),d.addEventListener("error",function(c){b.onFailure(a,d.responseText)},!1),d.open("POST",b.url,!0),d.setRequestHeader("X_FILENAME",(new Date).valueOf()),d.send(c)},funReturnNeedFiles:function(){return this.uploadFile},init:function(){var a=this;this.dragDrop&&(this.dragDrop.addEventListener("dragover",function(b){a.funDragHover(b)},!1),this.dragDrop.addEventListener("dragleave",function(b){a.funDragHover(b)},!1),this.dragDrop.addEventListener("drop",function(b){a.funGetFiles(b)},!1)),a.fileInput&&this.fileInput.addEventListener("change",function(b){a.funGetFiles(b)},!1),a.uploadInput&&this.uploadInput.addEventListener("click",function(b){a.funUploadFiles(b)},!1)}};!function(a,b){a.fn.zyUpload=function(b,c){var d=Array.prototype.slice.call(arguments,1);if("string"==typeof b){var e=this[0][b];if(a.isFunction(e))return e.apply(this,d);throw"zyUpload - No such method: "+b}return this.each(function(){var c={},d=this,e={width:"700px",height:"400px",itemWidth:"140px",itemHeight:"120px",url:"",multiple:!0,dragDrop:!0,del:!0,finishDel:!1,onSelect:function(a,b){},onDelete:function(a,b){},onSuccess:function(a){},onFailure:function(a){},onComplete:function(a){}};c=a.extend(e,b),this.init=function(){this.createHtml(),this.createCorePlug()},this.createHtml=function(){var b="";b=c.multiple?"multiple":"";var e="";if(c.dragDrop)e+='<form id="uploadForm" action="'+c.url+'" method="post" enctype="multipart/form-data">',e+='	<div class="upload_box">',e+='		<div class="upload_main">',e+='			<div class="upload_choose">',e+='				<div class="convent_choice">',e+='					<div class="andArea">',e+='						<div class="filePicker"><i class="fa fa-cloud-upload"></i> 点击选择图片</div>',e+='						<input id="fileImage" type="file" size="30" name="fileselect[]" '+b+">",e+="					</div>",e+="				</div>",e+='				<span id="fileDragArea" class="upload_drag_area">或者将图片拖到此处</span>',e+="			</div>",e+='			<div class="status_bar">',e+='				<div id="status_info" class="info">选中0张图片，共0B。</div>',e+='				<div class="btns">',e+='					<div class="webuploader_pick">继续选择</div>',e+='					<div class="upload_btn">开始上传</div>',e+="				</div>",e+="			</div>",e+='			<div id="preview" class="upload_preview"></div>',e+="		</div>",e+='		<div class="upload_submit">',e+='			<button type="button" id="fileSubmit" class="upload_submit_btn">确认上传图片</button>',e+="		</div>",e+='		<div id="uploadInf" class="upload_inf"></div>',e+="	</div>",e+="</form>";else{var f=parseInt(c.itemWidth.replace("px",""))-15;e+='<form id="uploadForm" action="'+c.url+'" method="post" enctype="multipart/form-data">',e+='	<div class="upload_box">',e+='		<div class="upload_main single_main">',e+='			<div class="status_bar">',e+='				<div id="status_info" class="info">选中0张图片，共0B。</div>',e+='				<div class="btns">',e+='					<input id="fileImage" type="file" size="30" name="fileselect[]" '+b+">",e+='					<div class="webuploader_pick">选择图片</div>',e+='					<div class="upload_btn">开始上传</div>',e+="				</div>",e+="			</div>",e+='			<div id="preview" class="upload_preview">',e+='				<div class="add_upload">',e+='					<a style="height:'+c.itemHeight+";width:"+c.itemWidth+';" title="点击添加图片" id="rapidAddImg" class="add_imgBox" href="javascript:void(0)">',e+='						<div class="uploadImg" style="width:'+f+'px">',e+='							<img class="upload_image" src="control/images/add_img.png" style="width:expression(this.width > '+f+" ? "+f+'px : this.width)" />',e+="						</div>",e+="					</a>",e+="				</div>",e+="			</div>",e+="		</div>",e+='		<div class="upload_submit">',e+='			<button type="button" id="fileSubmit" class="upload_submit_btn">确认上传图片</button>',e+="		</div>",e+='		<div id="uploadInf" class="upload_inf"></div>',e+="	</div>",e+="</form>"}a(d).append(e).css({width:c.width,height:c.height}),this.addEvent()},this.funSetStatusInfo=function(b){var c=0,d=b.length;a.each(b,function(a,b){c+=b.size}),c=c>1048576?(Math.round(100*c/1048576)/100).toString()+"MB":(Math.round(100*c/1024)/100).toString()+"KB",a("#status_info").html("选中"+d+"张文件，共"+c+"。")},this.funFilterEligibleFile=function(a){for(var b,c=[],d=0;b=a[d];d++)b.size>=512e5?alert('您这个"'+b.name+'"文件大小过大'):c.push(b);return c},this.funDisposePreviewHtml=function(a,b){var d="",e=parseInt(c.itemWidth.replace("px",""))-15,f="";c.del&&(f='<span class="file_del" data-index="'+a.index+'" title="删除"></span>');var g="control/images/fileType/";return g+=a.type.indexOf("rar")>0?"rar.png":a.type.indexOf("zip")>0?"zip.png":a.type.indexOf("text")>0?"txt.png":"file.png",0==a.type.indexOf("image")?(d+='<div id="uploadList_'+a.index+'" class="upload_append_list">',d+='	<div class="file_bar">',d+='		<div style="padding:5px;">',d+='			<p class="file_name">'+a.name+"</p>",d+=f,d+="		</div>",d+="	</div>",d+='	<a style="height:'+c.itemHeight+";width:"+c.itemWidth+';" href="#" class="imgBox">',d+='		<div class="uploadImg" style="width:'+e+'px">',d+='			<img id="uploadImage_'+a.index+'" class="upload_image" src="'+b.target.result+'" style="width:expression(this.width > '+e+" ? "+e+'px : this.width)" />',d+="		</div>",d+="	</a>",d+='	<p id="uploadProgress_'+a.index+'" class="file_progress"></p>',d+='	<p id="uploadFailure_'+a.index+'" class="file_failure">上传失败，请重试</p>',d+='	<p id="uploadSuccess_'+a.index+'" class="file_success"></p>',d+="</div>"):(d+='<div id="uploadList_'+a.index+'" class="upload_append_list">',d+='	<div class="file_bar">',d+='		<div style="padding:5px;">',d+='			<p class="file_name">'+a.name+"</p>",d+=f,d+="		</div>",d+="	</div>",d+='	<a style="height:'+c.itemHeight+";width:"+c.itemWidth+';" href="#" class="imgBox">',d+='		<div class="uploadImg" style="width:'+e+'px">',d+='			<img id="uploadImage_'+a.index+'" class="upload_image" src="'+g+'" style="width:expression(this.width > '+e+" ? "+e+'px : this.width)" />',d+="		</div>",d+="	</a>",d+='	<p id="uploadProgress_'+a.index+'" class="file_progress"></p>',d+='	<p id="uploadFailure_'+a.index+'" class="file_failure">上传失败，请重试</p>',d+='	<p id="uploadSuccess_'+a.index+'" class="file_success"></p>',d+="</div>"),d},this.createCorePlug=function(){var b={fileInput:a("#fileImage").get(0),uploadInput:a("#fileSubmit").get(0),dragDrop:a("#fileDragArea").get(0),url:a("#uploadForm").attr("action"),filterFile:function(a){return d.funFilterEligibleFile(a)},onSelect:function(b,e){c.onSelect(b,e),d.funSetStatusInfo(ZYFILE.funReturnNeedFiles());var f="",g=0,h=function(){if(file=b[g],file){var a=new FileReader;a.onload=function(a){f+=d.funDisposePreviewHtml(file,a),g++,h()},a.readAsDataURL(file)}else i(f)},i=function(b){c.dragDrop?a("#preview").append(b):a(".add_upload").before(b),j(),k()},j=function(){a(".file_del").length>0&&a(".file_del").click(function(){return ZYFILE.funDeleteFile(parseInt(a(this).attr("data-index")),!0),!1}),a(".file_edit").length>0&&a(".file_edit").click(function(){return!1})},k=function(){a(".upload_append_list").hover(function(b){a(this).find(".file_bar").addClass("file_hover")},function(b){a(this).find(".file_bar").removeClass("file_hover")})};h()},onDelete:function(b,e){a("#uploadList_"+b.index).fadeOut(),d.funSetStatusInfo(e),c.onDelete(b,e)},onProgress:function(b,c,d){var e=a("#uploadProgress_"+b.index),f=(c/d*100).toFixed(2)+"%";e.is(":hidden")&&e.show(),e.css("width",f)},onSuccess:function(b,e){a("#uploadProgress_"+b.index).hide(),a("#uploadSuccess_"+b.index).show(),c.finishDel&&(a("#uploadList_"+b.index).fadeOut(),d.funSetStatusInfo(ZYFILE.funReturnNeedFiles())),c.onSuccess(b,e)},onFailure:function(b){a("#uploadProgress_"+b.index).hide(),a("#uploadSuccess_"+b.index).show(),a("#uploadInf").append("<p>文件"+b.name+"上传失败！</p>"),c.onFailure(b)},onComplete:function(a){c.onComplete(a)},onDragOver:function(){a(this).addClass("upload_drag_hover")},onDragLeave:function(){a(this).removeClass("upload_drag_hover")}};ZYFILE=a.extend(ZYFILE,b),ZYFILE.init()},this.addEvent=function(){a(".filePicker").length>0&&a(".filePicker").bind("click",function(b){a("#fileImage").click()}),a(".webuploader_pick").bind("click",function(b){a("#fileImage").click()}),a(".upload_btn").bind("click",function(b){ZYFILE.funReturnNeedFiles().length>0?a("#fileSubmit").click():alert("请先选中文件再点击上传")}),a("#rapidAddImg").length>0&&a("#rapidAddImg").bind("click",function(b){a("#fileImage").click()})},this.init()})}}(jQuery),!function(a){"function"==typeof define&&define.amd?define(["jquery"],a):"object"==typeof exports?module.exports=a:a(jQuery)}(function(a){function b(b){var g=b||window.event,h=i.call(arguments,1),j=0,l=0,m=0,n=0,o=0,p=0;if(b=a.event.fix(g),b.type="mousewheel","detail"in g&&(m=-1*g.detail),"wheelDelta"in g&&(m=g.wheelDelta),"wheelDeltaY"in g&&(m=g.wheelDeltaY),"wheelDeltaX"in g&&(l=-1*g.wheelDeltaX),"axis"in g&&g.axis===g.HORIZONTAL_AXIS&&(l=-1*m,m=0),j=0===m?l:m,"deltaY"in g&&(m=-1*g.deltaY,j=m),"deltaX"in g&&(l=g.deltaX,0===m&&(j=-1*l)),0!==m||0!==l){if(1===g.deltaMode){var q=a.data(this,"mousewheel-line-height");j*=q,m*=q,l*=q}else if(2===g.deltaMode){var r=a.data(this,"mousewheel-page-height");j*=r,m*=r,l*=r}if(n=Math.max(Math.abs(m),Math.abs(l)),(!f||f>n)&&(f=n,d(g,n)&&(f/=40)),d(g,n)&&(j/=40,l/=40,m/=40),j=Math[j>=1?"floor":"ceil"](j/f),l=Math[l>=1?"floor":"ceil"](l/f),m=Math[m>=1?"floor":"ceil"](m/f),k.settings.normalizeOffset&&this.getBoundingClientRect){var s=this.getBoundingClientRect();o=b.clientX-s.left,p=b.clientY-s.top}return b.deltaX=l,b.deltaY=m,b.deltaFactor=f,b.offsetX=o,b.offsetY=p,b.deltaMode=0,h.unshift(b,j,l,m),e&&clearTimeout(e),e=setTimeout(c,200),(a.event.dispatch||a.event.handle).apply(this,h)}}function c(){f=null}function d(a,b){return k.settings.adjustOldDeltas&&"mousewheel"===a.type&&b%120===0}var e,f,g=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],h="onwheel"in document||document.documentMode>=9?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],i=Array.prototype.slice;if(a.event.fixHooks)for(var j=g.length;j;)a.event.fixHooks[g[--j]]=a.event.mouseHooks;var k=a.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener)for(var c=h.length;c;)this.addEventListener(h[--c],b,!1);else this.onmousewheel=b;a.data(this,"mousewheel-line-height",k.getLineHeight(this)),a.data(this,"mousewheel-page-height",k.getPageHeight(this))},teardown:function(){if(this.removeEventListener)for(var c=h.length;c;)this.removeEventListener(h[--c],b,!1);else this.onmousewheel=null;a.removeData(this,"mousewheel-line-height"),a.removeData(this,"mousewheel-page-height")},getLineHeight:function(b){var c=a(b),d=c["offsetParent"in a.fn?"offsetParent":"parent"]();return d.length||(d=a("body")),parseInt(d.css("fontSize"),10)||parseInt(c.css("fontSize"),10)||16},getPageHeight:function(b){return a(b).height()},settings:{adjustOldDeltas:!0,normalizeOffset:!0}};a.fn.extend({mousewheel:function(a){return a?this.bind("mousewheel",a):this.trigger("mousewheel")},unmousewheel:function(a){return this.unbind("mousewheel",a)}})}),function(a,b,c){"use strict";function d(a,b,c){var d,e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;return!/^-?[0-9]+\.?[0-9]*(?:px)?$/i.test(c)&&/^-?\d/.test(c)&&(d=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":c||0,c=f.pixelLeft+"px",f.left=d,e&&(a.runtimeStyle.left=e)),/^(thin|medium|thick)$/i.test(c)?c:Math.round(parseFloat(c))+"px"}function e(a){return parseInt(a,10)}function f(a,b,e,f){if(a=(a||"").split(","),a=a[f||0]||a[0]||"auto",a=l.Util.trimText(a).split(" "),"backgroundSize"!==e||a[0]&&!a[0].match(/cover|contain|auto/)){if(a[0]=-1===a[0].indexOf("%")?d(b,e+"X",a[0]):a[0],a[1]===c){if("backgroundSize"===e)return a[1]="auto",a;a[1]=a[0]}a[1]=-1===a[1].indexOf("%")?d(b,e+"Y",a[1]):a[1]}else;return a}function g(a,b,c,d,e,f){var g,h,i,j,k=l.Util.getCSS(b,a,e);if(1===k.length&&(j=k[0],k=[],k[0]=j,k[1]=j),-1!==k[0].toString().indexOf("%"))i=parseFloat(k[0])/100,h=c.width*i,"backgroundSize"!==a&&(h-=(f||d).width*i);else if("backgroundSize"===a)if("auto"===k[0])h=d.width;else if(/contain|cover/.test(k[0])){var m=l.Util.resizeBounds(d.width,d.height,c.width,c.height,k[0]);h=m.width,g=m.height}else h=parseInt(k[0],10);else h=parseInt(k[0],10);return"auto"===k[1]?g=h/d.width*d.height:-1!==k[1].toString().indexOf("%")?(i=parseFloat(k[1])/100,g=c.height*i,"backgroundSize"!==a&&(g-=(f||d).height*i)):g=parseInt(k[1],10),[h,g]}function h(a,b){var c=[];return{storage:c,width:a,height:b,clip:function(){c.push({type:"function",name:"clip",arguments:arguments})},translate:function(){c.push({type:"function",name:"translate",arguments:arguments})},fill:function(){c.push({type:"function",name:"fill",arguments:arguments})},save:function(){c.push({type:"function",name:"save",arguments:arguments})},restore:function(){c.push({type:"function",name:"restore",arguments:arguments})},fillRect:function(){c.push({type:"function",name:"fillRect",arguments:arguments})},createPattern:function(){c.push({type:"function",name:"createPattern",arguments:arguments})},drawShape:function(){var a=[];return c.push({type:"function",name:"drawShape",arguments:a}),{moveTo:function(){a.push({name:"moveTo",arguments:arguments})},lineTo:function(){a.push({name:"lineTo",arguments:arguments})},arcTo:function(){a.push({name:"arcTo",arguments:arguments})},bezierCurveTo:function(){a.push({name:"bezierCurveTo",arguments:arguments})},quadraticCurveTo:function(){a.push({name:"quadraticCurveTo",arguments:arguments})}}},drawImage:function(){c.push({type:"function",name:"drawImage",arguments:arguments})},fillText:function(){c.push({type:"function",name:"fillText",arguments:arguments})},setVariable:function(a,b){return c.push({type:"variable",name:a,arguments:b}),b}}}function i(a){return{zindex:a,children:[]}}var j,k,l={};l.Util={},l.Util.log=function(b){l.logging&&a.console&&a.console.log&&a.console.log(b)},l.Util.trimText=function(a){return function(b){return a?a.apply(b):((b||"")+"").replace(/^\s+|\s+$/g,"")}}(String.prototype.trim),l.Util.asFloat=function(a){return parseFloat(a)},function(){var a=/((rgba|rgb)\([^\)]+\)(\s-?\d+px){0,})/g,b=/(-?\d+px)|(#.+)|(rgb\(.+\))|(rgba\(.+\))/g;l.Util.parseTextShadows=function(c){if(!c||"none"===c)return[];for(var d=c.match(a),e=[],f=0;d&&f<d.length;f++){var g=d[f].match(b);e.push({color:g[0],offsetX:g[1]?g[1].replace("px",""):0,offsetY:g[2]?g[2].replace("px",""):0,blur:g[3]?g[3].replace("px",""):0})}return e}}(),l.Util.parseBackgroundImage=function(a){var b,c,d,e,f,g,h,i,j=" \r\n	",k=[],l=0,m=0,n=function(){b&&('"'===c.substr(0,1)&&(c=c.substr(1,c.length-2)),c&&i.push(c),"-"===b.substr(0,1)&&(e=b.indexOf("-",1)+1)>0&&(d=b.substr(0,e),b=b.substr(e)),k.push({prefix:d,method:b.toLowerCase(),value:f,args:i})),i=[],b=d=c=f=""};n();for(var o=0,p=a.length;p>o;o++)if(g=a[o],!(0===l&&j.indexOf(g)>-1)){switch(g){case'"':h?h===g&&(h=null):h=g;break;case"(":if(h)break;if(0===l){l=1,f+=g;continue}m++;break;case")":if(h)break;if(1===l){if(0===m){l=0,f+=g,n();continue}m--}break;case",":if(h)break;if(0===l){n();continue}if(1===l&&0===m&&!b.match(/^url$/i)){i.push(c),c="",f+=g;continue}}f+=g,0===l?b+=g:c+=g}return n(),k},l.Util.Bounds=function(a){var b,c={};return a.getBoundingClientRect&&(b=a.getBoundingClientRect(),c.top=b.top,c.bottom=b.bottom||b.top+b.height,c.left=b.left,c.width=a.offsetWidth,c.height=a.offsetHeight),c},l.Util.OffsetBounds=function(a){var b=a.offsetParent?l.Util.OffsetBounds(a.offsetParent):{top:0,left:0};return{top:a.offsetTop+b.top,bottom:a.offsetTop+a.offsetHeight+b.top,left:a.offsetLeft+b.left,width:a.offsetWidth,height:a.offsetHeight}},l.Util.getCSS=function(a,c,d){j!==a&&(k=b.defaultView.getComputedStyle(a,null));var g=k[c];if(/^background(Size|Position)$/.test(c))return f(g,a,c,d);if(/border(Top|Bottom)(Left|Right)Radius/.test(c)){var h=g.split(" ");return h.length<=1&&(h[1]=h[0]),h.map(e)}return g},l.Util.resizeBounds=function(a,b,c,d,e){var f,g,h=c/d,i=a/b;return e&&"auto"!==e?i>h^"contain"===e?(g=d,f=d*i):(f=c,g=c/i):(f=c,g=d),{width:f,height:g}},l.Util.BackgroundPosition=function(a,b,c,d,e){var f=g("backgroundPosition",a,b,c,d,e);return{left:f[0],top:f[1]}},l.Util.BackgroundSize=function(a,b,c,d){var e=g("backgroundSize",a,b,c,d);return{width:e[0],height:e[1]}},l.Util.Extend=function(a,b){for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b},l.Util.Children=function(a){var b;try{b=a.nodeName&&"IFRAME"===a.nodeName.toUpperCase()?a.contentDocument||a.contentWindow.document:function(a){var b=[];return null!==a&&!function(a,b){var d=a.length,e=0;if("number"==typeof b.length)for(var f=b.length;f>e;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];return a.length=d,a}(b,a),b}(a.childNodes)}catch(d){l.Util.log("html2canvas.Util.Children failed with exception: "+d.message),b=[]}return b},l.Util.isTransparent=function(a){return"transparent"===a||"rgba(0, 0, 0, 0)"===a},l.Util.Font=function(){var a={};return function(b,d,e){if(a[b+"-"+d]!==c)return a[b+"-"+d];var f,g,h,i=e.createElement("div"),j=e.createElement("img"),k=e.createElement("span"),l="Hidden Text";return i.style.visibility="hidden",i.style.fontFamily=b,i.style.fontSize=d,i.style.margin=0,i.style.padding=0,e.body.appendChild(i),j.src="data:image/gif;base64,R0lGODlhAQABAIABAP///wAAACwAAAAAAQABAAACAkQBADs=",j.width=1,j.height=1,j.style.margin=0,j.style.padding=0,j.style.verticalAlign="baseline",k.style.fontFamily=b,k.style.fontSize=d,k.style.margin=0,k.style.padding=0,k.appendChild(e.createTextNode(l)),i.appendChild(k),i.appendChild(j),f=j.offsetTop-k.offsetTop+1,i.removeChild(k),i.appendChild(e.createTextNode(l)),i.style.lineHeight="normal",j.style.verticalAlign="super",g=j.offsetTop-i.offsetTop+1,h={baseline:f,lineWidth:1,middle:g},a[b+"-"+d]=h,e.body.removeChild(i),h}}(),function(){function a(a){return function(b){try{a.addColorStop(b.stop,b.color)}catch(d){c.log(["failed to add color stop: ",d,"; tried to add: ",b])}}}var c=l.Util,d={};l.Generate=d;var e=[/^(-webkit-linear-gradient)\(([a-z\s]+)([\w\d\.\s,%\(\)]+)\)$/,/^(-o-linear-gradient)\(([a-z\s]+)([\w\d\.\s,%\(\)]+)\)$/,/^(-webkit-gradient)\((linear|radial),\s((?:\d{1,3}%?)\s(?:\d{1,3}%?),\s(?:\d{1,3}%?)\s(?:\d{1,3}%?))([\w\d\.\s,%\(\)\-]+)\)$/,/^(-moz-linear-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?))([\w\d\.\s,%\(\)]+)\)$/,/^(-webkit-radial-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?)),\s(\w+)\s([a-z\-]+)([\w\d\.\s,%\(\)]+)\)$/,/^(-moz-radial-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?)),\s(\w+)\s?([a-z\-]*)([\w\d\.\s,%\(\)]+)\)$/,/^(-o-radial-gradient)\(((?:\d{1,3}%?)\s(?:\d{1,3}%?)),\s(\w+)\s([a-z\-]+)([\w\d\.\s,%\(\)]+)\)$/];d.parseGradient=function(a,b){var c,d,f,g,h,i,j,k,l,m,n,o,p=e.length;for(d=0;p>d&&!(f=a.match(e[d]));d+=1);if(f)switch(f[1]){case"-webkit-linear-gradient":case"-o-linear-gradient":if(c={type:"linear",x0:null,y0:null,x1:null,y1:null,colorStops:[]},h=f[2].match(/\w+/g))for(i=h.length,d=0;i>d;d+=1)switch(h[d]){case"top":c.y0=0,c.y1=b.height;break;case"right":c.x0=b.width,c.x1=0;break;case"bottom":c.y0=b.height,c.y1=0;break;case"left":c.x0=0,c.x1=b.width}if(null===c.x0&&null===c.x1&&(c.x0=c.x1=b.width/2),null===c.y0&&null===c.y1&&(c.y0=c.y1=b.height/2),h=f[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g))for(i=h.length,j=1/Math.max(i-1,1),d=0;i>d;d+=1)k=h[d].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),k[2]?(g=parseFloat(k[2]),g/="%"===k[3]?100:b.width):g=d*j,c.colorStops.push({color:k[1],stop:g});break;case"-webkit-gradient":if(c={type:"radial"===f[2]?"circle":f[2],x0:0,y0:0,x1:0,y1:0,colorStops:[]},h=f[3].match(/(\d{1,3})%?\s(\d{1,3})%?,\s(\d{1,3})%?\s(\d{1,3})%?/),h&&(c.x0=h[1]*b.width/100,c.y0=h[2]*b.height/100,c.x1=h[3]*b.width/100,c.y1=h[4]*b.height/100),h=f[4].match(/((?:from|to|color-stop)\((?:[0-9\.]+,\s)?(?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)\))+/g))for(i=h.length,d=0;i>d;d+=1)k=h[d].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/),g=parseFloat(k[2]),"from"===k[1]&&(g=0),"to"===k[1]&&(g=1),c.colorStops.push({color:k[3],stop:g});break;case"-moz-linear-gradient":if(c={type:"linear",x0:0,y0:0,x1:0,y1:0,colorStops:[]},h=f[2].match(/(\d{1,3})%?\s(\d{1,3})%?/),h&&(c.x0=h[1]*b.width/100,c.y0=h[2]*b.height/100,c.x1=b.width-c.x0,c.y1=b.height-c.y0),h=f[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}%)?)+/g))for(i=h.length,j=1/Math.max(i-1,1),d=0;i>d;d+=1)k=h[d].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%)?/),k[2]?(g=parseFloat(k[2]),k[3]&&(g/=100)):g=d*j,c.colorStops.push({color:k[1],stop:g});break;case"-webkit-radial-gradient":case"-moz-radial-gradient":case"-o-radial-gradient":if(c={type:"circle",x0:0,y0:0,x1:b.width,y1:b.height,cx:0,cy:0,rx:0,ry:0,colorStops:[]},h=f[2].match(/(\d{1,3})%?\s(\d{1,3})%?/),h&&(c.cx=h[1]*b.width/100,c.cy=h[2]*b.height/100),h=f[3].match(/\w+/),k=f[4].match(/[a-z\-]*/),h&&k)switch(k[0]){case"farthest-corner":case"cover":case"":l=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.cy,2)),m=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.y1-c.cy,2)),n=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.y1-c.cy,2)),o=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.cy,2)),c.rx=c.ry=Math.max(l,m,n,o);break;case"closest-corner":l=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.cy,2)),m=Math.sqrt(Math.pow(c.cx,2)+Math.pow(c.y1-c.cy,2)),n=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.y1-c.cy,2)),o=Math.sqrt(Math.pow(c.x1-c.cx,2)+Math.pow(c.cy,2)),c.rx=c.ry=Math.min(l,m,n,o);break;case"farthest-side":"circle"===h[0]?c.rx=c.ry=Math.max(c.cx,c.cy,c.x1-c.cx,c.y1-c.cy):(c.type=h[0],c.rx=Math.max(c.cx,c.x1-c.cx),c.ry=Math.max(c.cy,c.y1-c.cy));break;case"closest-side":case"contain":"circle"===h[0]?c.rx=c.ry=Math.min(c.cx,c.cy,c.x1-c.cx,c.y1-c.cy):(c.type=h[0],c.rx=Math.min(c.cx,c.x1-c.cx),c.ry=Math.min(c.cy,c.y1-c.cy))}if(h=f[5].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g))for(i=h.length,j=1/Math.max(i-1,1),d=0;i>d;d+=1)k=h[d].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),
